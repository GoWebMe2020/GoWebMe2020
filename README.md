...
🚀 **[Invitify](https://www.jpferreira.com/projects/invitify)** - *Shipped July 2026.*

Modern event-invitation and RSVP platform. Pay-per-event, no guest accounts, built end-to-end as a solo founder. 

`Next.js` `TypeScript` `Python` `Django` `DRF` `PostgreSQL` `OpenAI` `Stripe` `Celery` `Redis` `pytest` `AWS S3` `Fly.io` `Vercel` `Sentry`

🧾 **[ClauseQ](https://www.jpferreira.com/projects/clauseq)** - *Public Reference Repo.*

AI-powered SaaS that prevents missed contract deadlines. Document parsing with human-in-the-loop validation, multi-tenant workspaces, Stripe billing. 
...
📝 **[What construction taught me about shipping software](https://www.jpferreira.com/writing/what-construction-taught-me)** - Eighteen years on building sites before I wrote a line of production code. The lessons that transferred weren't the ones I expected.

📝 **[The model was the easy part: shipping an AI assistant into Invitify](https://www.jpferreira.com/writing/the-model-was-the-easy-part)** - What it took to put a plain-language event-setup assistant in front of real users - the guardrails, the gates, the one rule it could never break, and why almost none of the work was about the model.
